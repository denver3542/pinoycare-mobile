...
export function useDashboard() {
  ...
  const deleteApplication = useMutation(
    (applicationId) =>
      deleteResource("/delete/applications", "application_id", applicationId),
    {
        ...
        queryClient.setQueryData(["dashboard"], (old) => {
          ...
          return {
            ...
            applications: old.applications
              ? old.applications.filter((app) => app.id !== applicationId)
              : [],
          };
        });
  ...
  const deleteJobOffer = useMutation(
    (jobOfferId) =>
      deleteResource("/delete/job-offers", "job_offers_id", jobOfferId),
    {
      onMutate: async (jobOfferId) => {
        ...
        queryClient.setQueryData(["dashboard"], (old) => {
          ...
          return {
            ...old,
            jobOffers: old.jobOffers
              ? old.jobOffers.filter((offer) => offer.id !== jobOfferId)
              : [],
          };
        });
  ...
  const deleteSavedJob = useMutation(
    (savedJobId) =>
      deleteResource("/delete/saved-jobs", "savedjob_id", savedJobId),
    {
      onMutate: async (savedJobId) => {
        ...
        queryClient.setQueryData(["dashboard"], (old) => {
          ...
          return {
            ...old,
            savedJobs: old.savedJobs
              ? old.savedJobs.filter((job) => job.id !== savedJobId)
              : [],
          };
        });
